...
def upmid_lifeexpectancy():
    countrylist=["Brazil", "China", "Jordan", "Malaysia", "South Africa", "Thailand"]
    def life_expectancy():
        y = df.Time.to_list()
    ...
    for name in countrylist:
        ...
        plt.title(r"(a) Predicted Life Expectancy of Upper-Middle-Income Countries",fontweight='bold',fontsize=28)
        plt.tight_layout()
        plt.grid()

def up_lifeexpectancy():
    countrylist=["Australia","Canada","France","Germany","Japan","Saudi Arabia","Singapore","United Kingdom","United States"]
    def life_expectancy():
        y = df.Time.to_list()
        age = df.LifeExpectancy.to_list()
        country = df.Country.to_list()
    ...
    # funct = np.linspace(2019, 2019, 100)
    ...
    for name in countrylist:
        ...
        plt.ylabel(r"Life Expectancy (In Years)", fontsize= 20)
        plt.legend(loc="lower right", prop={'size': 26})
        plt.title(r"(b) Predicted Life Expectancy of High-Income Countries",fontweight='bold',fontsize=28)
        plt.tight_layout()
upmid_lifeexpectancy()
up_lifeexpectancy()
plt.savefig('upmid_up.png')
plt.show()
